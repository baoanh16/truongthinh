                ...
                <table class="truongthinh-table-v1">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <xsl:value-of disable-output-escaping="yes" select="/NewsList/ViewText"></xsl:value-of>
                            </th>
                            <th>
        ...
        <div class="col-md-6">
            <div class="item">
                ...
                <a class="download_document btn-download" data-mimeType="pdf">
                    ...
                    <em class="mdi mdi-download"></em>
                    <span>
                        <xsl:value-of disable-output-escaping='yes' select='/NewsList/DownloadText'></xsl:value-of>
                    </span>
                </a>
            </div>
        </div>
