                ...
                <asp:Panel ID="pnlNewComment" DefaultButton="btnPostComment" runat="server">
                    <h4>
                        <asp:Literal ID="litNote" Text="<%$Resources:NewsResources, JobNoteLabel %>" EnableViewState="false"
                            runat="server" />
                        (<span class="required"><asp:Literal ID="litNoteStarRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litPositionLabel" Text="<%$Resources:NewsResources, JobPositionLabel %>"
                                    EnableViewState="false" runat="server" />
                                (<span class="required"><asp:Literal ID="litPositionRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtPosition" CssClass="form-control" MaxLength="255" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqPosition" ToolTip="<%$Resources:NewsResources, JobPositionRequiredLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litEmail" Text="<%$Resources:NewsResources, JobEmailLabel %>" EnableViewState="false"
                                    runat="server" />
                                (<span class="required"><asp:Literal ID="litEmailRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtEmail" CssClass="form-control" MaxLength="255" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqEmail" ToolTip="<%$Resources:NewsResources, JobEmailRequiredLabel %>"
                                ValidationGroup="jobapply" runat="server" Display="Dynamic" ControlToValidate="txtEmail"
                                SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="regexEmail" ToolTip="<%$Resources:NewsResources, JobValidEmailLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litFullName" Text="<%$Resources:NewsResources, JobFullNameLabel %>"
                                    EnableViewState="false" runat="server" />
                                (<span class="required"><asp:Literal ID="litFullNameRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtFullName" CssClass="form-control" MaxLength="255" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqFullName" ToolTip="<%$Resources:NewsResources, JobFullNameRequiredLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litPhone" Text="<%$Resources:NewsResources, JobPhoneLabel %>" EnableViewState="false"
                                    runat="server" />
                                (<span class="required"><asp:Literal ID="litPhoneRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtPhone" CssClass="form-control" MaxLength="255" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqPhone" ToolTip="<%$Resources:NewsResources, JobPhoneRequiredLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litAddress" Text="<%$Resources:NewsResources, JobAddressLabel %>"
                                    EnableViewState="false" runat="server" />
                                (<span class="required"><asp:Literal ID="litAddressRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtAddress" CssClass="form-control" MaxLength="255" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqAddress" ToolTip="<%$Resources:NewsResources, JobAddressRequiredLabel %>"
                        ...
                        <div class="form-group">
                            <label class="label">
                                <asp:Literal ID="litMessageLabel" Text="<%$Resources:NewsResources, JobMessageLabel %>"
                                    EnableViewState="false" runat="server" />
                                (<span class="required"><asp:Literal ID="litMessageRequired" Text="<%$Resources:NewsResources, JobRequiredStarLabel %>"
                                    EnableViewState="false" runat="server" /></span>)
                            </label>
                            <asp:TextBox ID="txtMessage" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqMessage" ToolTip="<%$Resources:NewsResources, JobEmptyMessageWarning %>"
